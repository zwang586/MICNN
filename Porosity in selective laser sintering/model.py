...
def yNet(nx2,ny2):  
    ...
    input_v = Input(shape=(1,),name = 'Input2')
    input_p = Input(shape=(1,),name = 'Input3')
    ...
    in1 = concatenate([input_v,input_p], axis = 1)
    h1 = Dense(128, activation='sigmoid',name = 'fc1')(in1)
    ...
    model = Model([input_X,input_v,input_p], Y)
